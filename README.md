# Flappy Bird Based Test Project
...
**Sonic's Flight:**
![Sonic's Flight](img/Screenshot%202024-08-25%20153644.png)
...
1. **Clone the Repository:**
   - Run `git clone https://github.com/Gatorrante/FlappyBirdBasedTestProject.git` to clone the repository.

2. **Navigate to the Project Directory:**
   - `cd FlappyBirdBasedTestProject`
...
<details>
  ...
  # Proyecto de Prueba Basado en Flappy Bird
  ...
  **Vuelo de Sonic:**
  ![Vuelo de Sonic](img/Screenshot%202024-08-25%20153644.png)
  ...
  **Mecánicas de Flappy Bird:**
  ...
  1. **Clonar el Repositorio:**
     - Ejecuta `git clone https://github.com/Gatorrante/FlappyBirdBasedTestProject.git` para clonar el repositorio.
